    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <a titile="Refresh Table" class="btn btn-success btn-round ml-1 float-right" href="<?= Url::toRoute('location/state'); ?>">
...
// the name column configuration
                [
                    ...
                    'value'=>function ($model) {
                        return \common\models\Countries::GetNameById($model->country_id);
                    },
                    ...
                    'buttons'  => [
                        ...
                        'leadDelete' => function ($url, $model,$key) {
                            ...
                            return Html::a('<span class="flaticon-interface-5"></span>', $url, [
                                ...
                                'record-delete-url'=>Url::toRoute('delete/state/'.$model->id),
                                'record-data-key'=>$key,
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php $form = ActiveForm::begin([
                'action' => ['edit/add-state'],
                'options' => ['id' => 'state_form','class' => 'master-form']
            ]); ?>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        ])->textInput(['placeholder'=>'Enter State/Region name?']) ?>

                        <?php echo $form->field($searchModel, 'country_id', [
                            'template' => '
