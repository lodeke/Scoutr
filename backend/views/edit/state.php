            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php $form = ActiveForm::begin(['id' => 'state-form']); ?>
                        <?php echo  $form->field($cat, 'country_id')->dropDownList(\yii\helpers\ArrayHelper::map(common\models\Countries::find()->all(),'id','name'),
                            ['prompt'=>'Choose Countries',

                            ])->label('Choose Countries')
                        ?>
                        <?php echo  $form->field($cat, 'name')->label('State name') ?>

                    <div class="form-group">
                        <a class="btn btn-info" href="<?php echo  \yii\helpers\Url::toRoute('location/state'); ?>">
                            Back
                        </a>
