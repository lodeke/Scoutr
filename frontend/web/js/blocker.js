...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    function stackedCards () {
        ...
        dataUrl = {prob1 : 'one', prob2:'hello'};//document.getElementById('stacked-cards-block');
        ...
        function ChooseLike()
        {
            dataUrl = currentElementObj.getAttribute("dataUrl")+"/like";
            var user = currentElementObj.id;
            var result;
            $.ajax({
                url: dataUrl,
                type: 'GET',
        ...
        {
            dataUrl = currentElementObj.getAttribute("dataUrl")+"/dislike";
            var user = currentElementObj.id;
            var result;
            $.ajax({
                url: dataUrl,
        ...
        buttonLeft.addEventListener('click', ChooseDislike, false);
        buttonTop.addEventListener('click', onActionTop, false);
        buttonRight.addEventListener('click', ChooseLike, false);
